import type { generateColumnContent } from '../../utils';
import type { ServerOptionsComputed, HeaderForRender, MultipleSelectStatus } from '../../types/internal';
import type { LooseRequired } from '@vue/shared';
import type { Item, Header, FilterOption, ServerOptions, SortType, HeaderItemClassNameFunction, BodyRowClassNameFunction, BodyItemClassNameFunction } from '../..';
import type { DefineComponent, PropType, ExtractPropTypes, Ref, ComputedRef, Slot, WritableComputedRef, ComponentOptionsMixin, VNodeProps, AllowedComponentProps, ComponentCustomProps, EmitsOptions } from 'vue';
import type { SFCWithInstall } from '../../helpers';
export declare const EasyDataTable: SFCWithInstall<DefineComponent<{
    items: {
        type: PropType<Item[]>;
        required: true;
    };
